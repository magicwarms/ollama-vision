...
export declare class ConversationalAi {
     ...
     */
    getAgentKnowledgeBaseDocumentById(agentId: string, documentationId: string, requestOptions?: ConversationalAi.RequestOptions): Promise<ElevenLabs.GetKnowledgeBaseReponseModel>;
    /**
     ...
     */
    addToAgentKnowledgeBase(agentId: string, request: ElevenLabs.BodyAddToAgentSKnowledgeBaseV1ConvaiAgentsAgentIdAddToKnowledgeBasePost, requestOptions?: ConversationalAi.RequestOptions): Promise<ElevenLabs.AddKnowledgeBaseResponseModel>;
    /**
